...
namespace NotesMarketPlace.Controllers
{
    public class adminController : BaseController
    {
                ...
                if (command == "unpublish")
                {
                    ...
                    { 
                        ...
                        if (check2 != null && i > 0)
                        {
                            ...
                            var fromMail = new MailAddress("makwanapilu664@gmail.com", "pilumak@22797");
        ...
        public IEnumerable<ViewModel> sortingMembers(string SortOrder, string SortBy, IEnumerable<ViewModel> query1)
        {
            ViewBag.SortOrder = SortOrder;
            switch (SortBy)
            {
        ...
        public ActionResult members(int? pageindex, string searchTxt, string SortOrder, string SortBy, string DeactivateForId, string command)
        {
            ...
            else
            {
                ...
                query = sortingMembers(SortOrder, SortBy, query);
        ...
        public ActionResult manageAdministrator(int? pageindex, string searchTxt, string DeactivateForId, string command)
        {
            ...
            else
            {
                ...
                if (check.roleID == 6)
                {
                    ...
                    //var q = db.tblUsers.Where(m => m.roleID==1 && m.isActive).ToList();
        ...
        [HttpPost]
        public ActionResult editCountry(tblManageCountry tmc, string command)
        {
